...
Fields from the DNS zones.


[float]
=== dns

All fields specific to the Resource Record are defined here.
...
+
--
The protocol family or instance of a protocol.
...
This is a non-exhaustive list of the type and sometimes class dependent data which describes the resource.
...
*`dns.rdata.public_key_algorithm`*::
+
--
type: keyword
